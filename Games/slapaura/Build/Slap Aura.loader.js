function createUnityInstance(t, n, d) {
  ...
  m.SystemInfo = function() {
    ...
    version: 1
  }, p = "RequestStore", g = "WebAssembly", b = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB, y = null, E.getInstance = function() {
    return y = y || new E
  }, E.destroyInstance = function() {
    return y ? y.close().then(function() {
      y = null
    }) : Promise.resolve()
  ...
  }, E), m.cachedFetch = (w = m.UnityCache, v = m.fetchWithProgress, C = m.readBodyWithProgress, function(o, a) {
    ...
    return a && (d.control = a.control, d.companyName = a.companyName, d.productName = a.productName, d.productVersion = a.productVersion), d.revalidated = !1, d.metaData = {
      ...
      return U("Failed to load '" + d.metaData.url + "' from browser cache due to the error: " + e), v(o, a)
    }) : v(o, a)
  });
  var A = {
    gzip: {
